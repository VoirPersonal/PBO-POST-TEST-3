...
public class PT1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("- Overriding: Method yang disesuaikan untuk setiap jenis sampah");
        ...
        while (true) {
            ...
            // Validasi input menu
            if (!isAngkaValid(input, 1, 8)) {
                System.out.println("Input tidak valid! Harus angka antara 1-8.");
                continue;
            }
